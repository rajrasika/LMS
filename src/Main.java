class TestAccountInterface {
    ...
    public static void transactOnAccount(IAccount account) {
        ...
        printBalance("depositing 30,000.0", account);
        account.withdraw(2500.0);
        printBalance("withdrawing 3,500.0", account);
        account.withdraw(4100.0);
        printBalance("withdrawing 6,100.0", account);
        account.deposit(5000.0);
        printBalance("depositing 3,000.0", account);
        System.out.println("------------------------------");
    }
